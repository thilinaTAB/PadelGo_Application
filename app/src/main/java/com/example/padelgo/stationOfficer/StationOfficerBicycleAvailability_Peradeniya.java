...
public class StationOfficerBicycleAvailability_Peradeniya extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_station_officer_bicycle_availability_peradeniya);
    ...
    private void updateFirebase(String bikeType, int value) {
        String path = "bicycleAvailability_Peradeniya/" + bikeType;
